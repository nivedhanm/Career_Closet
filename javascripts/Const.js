...
SI.Sizes = {
	...
	SI.Sizes.playerShipWidth = 28 * SI.Sizes.modifier;
	SI.Sizes.playerShipHeight = 50 * SI.Sizes.modifier;
	SI.Sizes.playerStep = 50 * SI.Sizes.modifier;
...
SI.Images.playerImg.width = 28;
SI.Images.playerImg.height = 50;
